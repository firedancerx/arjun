...
//clsFileUpload Class @0-BB6366E1
class clsFileUpload
{
...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    ...
    $this->Messages["ccs_localeid"] = "en-GB";
    ...
    $this->Messages["conductorsizingcalculationsprojects_gridform"] = "List of Conductorsizingcalculations, Projects ";
    $this->Messages["conductorsizingcalculationsprojectsprojecttypes_gridform"] = "List of Conductorsizingcalculations, Projects, Projecttypes ";
    $this->Messages["isactive"] = "Isactive";
    $this->Messages["menu"] = "Menu";
    $this->Messages["projectname"] = "Projectname";
    $this->Messages["projects"] = "Projects";
    $this->Messages["projects_id"] = "Projects Id";
    $this->Messages["projects_isactive"] = "Projects Isactive";
    $this->Messages["projectsnew1"] = "Projectsnew1";
    $this->Messages["projectsnew_gridform"] = " List of Projectsnew ";
    $this->Messages["projecttype"] = "Projecttype";
    $this->Messages["projectyear"] = "Projectyear";
    $this->Messages["qryprojnew1"] = "Qry Proj New1";
    $this->Messages["qryprojnew_gridform"] = " List of QryProjNew ";
    $this->Messages["search_form"] = "Search";
    $this->Messages["substation"] = "Substation";
    $this->IsLoaded = true;
  }
