<?php
//Include Common Files @1-68456FBE
define("RelativePath", "..");
define("PathToCurrentPage", "/projectsdesignedit/");
...
class clsRecordconductorsizingcalculations { //conductorsizingcalculations Class @8-200B36CB
...
//Class_Initialize Event @8-F493DAEA
    function clsRecordconductorsizingcalculations($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record conductorsizingcalculations/Error";
        $this->DataSource = new clsconductorsizingcalculationsDataSource($this);
        ...
        if($this->Visible)
        {
            $this->ComponentName = "conductorsizingcalculations";
            ...
            $this->projectid->DataSource->SQL = "SELECT * \n" .
...
} //End conductorsizingcalculations Class @8-FCB6E20C

class clsconductorsizingcalculationsDataSource extends clsDBlocalhost {  //conductorsizingcalculationsDataSource Class @8-7908C0AB

//DataSource Variables @8-DBAA6778
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @8-AD810C9E
    function clsconductorsizingcalculationsDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record conductorsizingcalculations/Error";
        $this->Initialize();
        ...
        $this->UpdateFields["projectid"] = array("Name" => "projectid", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["rvikvrms"] = array("Name" => "rvikvrms", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["scxrratio"] = array("Name" => "scxrratio", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["issccurrt"] = array("Name" => "issccurrt", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["ssssscurrt"] = array("Name" => "ssssscurrt", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["dosccurrt"] = array("Name" => "dosccurrt", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["dorsccurrt"] = array("Name" => "dorsccurrt", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["sysfreq"] = array("Name" => "sysfreq", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["rccratg"] = array("Name" => "rccratg", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["noppwires"] = array("Name" => "noppwires", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["spanlgth"] = array("Name" => "spanlgth", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["hocondctr"] = array("Name" => "hocondctr", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["ipspacg"] = array("Name" => "ipspacg", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["acsvgradt"] = array("Name" => "acsvgradt", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["make"] = array("Name" => "make", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["coorigin"] = array("Name" => "coorigin", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["toalloy"] = array("Name" => "toalloy", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["ccname"] = array("Name" => "ccname", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["edcrocond"] = array("Name" => "edcrocond", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["shocmatrl"] = array("Name" => "shocmatrl", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["docondmatrl"] = array("Name" => "docondmatrl", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["comatrl"] = array("Name" => "comatrl", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["tcorestnce"] = array("Name" => "tcorestnce", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["ccsectn"] = array("Name" => "ccsectn", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["overalldiam"] = array("Name" => "overalldiam", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["dbscctrs"] = array("Name" => "dbscctrs", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["mpulength"] = array("Name" => "mpulength", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["ambtemp"] = array("Name" => "ambtemp", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["fctemp"] = array("Name" => "fctemp", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["ctabeginosc"] = array("Name" => "ctabeginosc", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["ctaendosc"] = array("Name" => "ctaendosc", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["cwindspeed"] = array("Name" => "cwindspeed", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["sracoeff"] = array("Name" => "sracoeff", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["iosradtn"] = array("Name" => "iosradtn", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        $this->UpdateFields["ecoeffirtbb"] = array("Name" => "ecoeffirtbb", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
        $this->UpdateFields["ymoelas"] = array("Name" => "ymoelas", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
    }
...
//Update Method @8-C62847D1
    function Update()
    {
        ...
        $this->UpdateFields["projectid"]["Value"] = $this->projectid->GetDBValue(true);
        $this->UpdateFields["rvikvrms"]["Value"] = $this->rvikvrms->GetDBValue(true);
        $this->UpdateFields["scxrratio"]["Value"] = $this->scxrratio->GetDBValue(true);
        $this->UpdateFields["issccurrt"]["Value"] = $this->issccurrt->GetDBValue(true);
        $this->UpdateFields["ssssscurrt"]["Value"] = $this->ssssscurrt->GetDBValue(true);
        $this->UpdateFields["dosccurrt"]["Value"] = $this->dosccurrt->GetDBValue(true);
        $this->UpdateFields["dorsccurrt"]["Value"] = $this->dorsccurrt->GetDBValue(true);
        $this->UpdateFields["sysfreq"]["Value"] = $this->sysfreq->GetDBValue(true);
        $this->UpdateFields["rccratg"]["Value"] = $this->rccratg->GetDBValue(true);
        $this->UpdateFields["noppwires"]["Value"] = $this->noppwires->GetDBValue(true);
        $this->UpdateFields["spanlgth"]["Value"] = $this->spanlgth->GetDBValue(true);
        $this->UpdateFields["hocondctr"]["Value"] = $this->hocondctr->GetDBValue(true);
        $this->UpdateFields["ipspacg"]["Value"] = $this->ipspacg->GetDBValue(true);
        $this->UpdateFields["acsvgradt"]["Value"] = $this->acsvgradt->GetDBValue(true);
        $this->UpdateFields["make"]["Value"] = $this->make->GetDBValue(true);
        $this->UpdateFields["coorigin"]["Value"] = $this->coorigin->GetDBValue(true);
        $this->UpdateFields["toalloy"]["Value"] = $this->toalloy->GetDBValue(true);
        $this->UpdateFields["ccname"]["Value"] = $this->ccname->GetDBValue(true);
        $this->UpdateFields["edcrocond"]["Value"] = $this->edcrocond->GetDBValue(true);
        $this->UpdateFields["shocmatrl"]["Value"] = $this->shocmatrl->GetDBValue(true);
        $this->UpdateFields["docondmatrl"]["Value"] = $this->docondmatrl->GetDBValue(true);
        $this->UpdateFields["comatrl"]["Value"] = $this->comatrl->GetDBValue(true);
        $this->UpdateFields["tcorestnce"]["Value"] = $this->tcorestnce->GetDBValue(true);
        $this->UpdateFields["ccsectn"]["Value"] = $this->ccsectn->GetDBValue(true);
        $this->UpdateFields["overalldiam"]["Value"] = $this->overalldiam->GetDBValue(true);
        $this->UpdateFields["dbscctrs"]["Value"] = $this->dbscctrs->GetDBValue(true);
        $this->UpdateFields["mpulength"]["Value"] = $this->mpulength->GetDBValue(true);
        $this->UpdateFields["ambtemp"]["Value"] = $this->ambtemp->GetDBValue(true);
        $this->UpdateFields["fctemp"]["Value"] = $this->fctemp->GetDBValue(true);
        $this->UpdateFields["ctabeginosc"]["Value"] = $this->ctabeginosc->GetDBValue(true);
        $this->UpdateFields["ctaendosc"]["Value"] = $this->ctaendosc->GetDBValue(true);
        $this->UpdateFields["cwindspeed"]["Value"] = $this->cwindspeed->GetDBValue(true);
        $this->UpdateFields["sracoeff"]["Value"] = $this->sracoeff->GetDBValue(true);
        $this->UpdateFields["iosradtn"]["Value"] = $this->iosradtn->GetDBValue(true);
        $this->UpdateFields["ecoeffirtbb"]["Value"] = $this->ecoeffirtbb->GetDBValue(true);
        $this->UpdateFields["ymoelas"]["Value"] = $this->ymoelas->GetDBValue(true);
        $this->SQL = CCBuildUpdate("conductorsizingcalculations", $this->UpdateFields, $this);
...
//Delete Method @8-E8E00683
    function Delete()
    {
        ...
        $this->SQL = "DELETE FROM conductorsizingcalculations";
...
} //End conductorsizingcalculationsDataSource Class @8-FCB6E20C
...
$conductorsizingcalculations = new clsRecordconductorsizingcalculations("", $MainPage);
...
$MainPage->conductorsizingcalculations = & $conductorsizingcalculations;
$MainPage->Menu = & $Menu;
...
$Content->AddComponent("conductorsizingcalculations", $conductorsizingcalculations);
...
$conductorsizingcalculations->Initialize();
$ScriptIncludes = "";
...
//Execute Components @1-A6B58CFB
$MasterPage->Operations();
$headerincludablepage->Operations();
$menuincludablepage->Operations();
$conductorsizingcalculations->Operation();
//End Execute Components

//Go to destination page @1-F55A5A86
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBlocalhost->close();
    header("Location: " . $Redirect);
    unset($conductorsizingcalculations);
