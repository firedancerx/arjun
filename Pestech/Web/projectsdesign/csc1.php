<?php
//Include Common Files @1-866AA114
define("RelativePath", "..");
define("PathToCurrentPage", "/projectsdesign/");
define("FileName", "csc1.php");
...
//Include events file @1-583BB7EF
include_once("./csc1_events.php");
